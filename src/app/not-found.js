  ...
  return (
    <div className="min-h-screen relative overflow-hidden  flex items-center justify-center px-6">
      ...
      <div className="relative backdrop-blur-xl bg-white/10 border border-white/10 rounded-3xl p-10 md:p-14 max-w-xl w-full shadow-2xl text-center">
        ...
        {/* 404 */}
        <h1 className="text-7xl md:text-9xl font-extrabold bg-gradient-to-r from-green-400 via-green-400 to-green-400 bg-clip-text text-transparent">
          404
        </h1>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-green-500 to-green-500 text-white font-semibold shadow-lg hover:scale-105 transition-all duration-300"
          >
            <Home size={18} />
            Back Home
          </Link>
